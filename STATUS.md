...
| **Databasefriskhet** | Siste data: `daily_summary` = 2026-04-29S, `ingest.py` selv er oppdatert — **ikke drift mellom schema.ts, db_setup.py, ingest.py**. Problemet er bare at pipeline ikke har kjørt. | 🛈 Operasjonelt |
