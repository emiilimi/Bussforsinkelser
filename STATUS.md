...
| **Databasefriskhet** | Siste data: `daily_summary` = 2026-03-20, `journey_stop_weekly` = uke 2026-03-16 (5+ uker gammelt). `ingest.py` selv er oppdatert — **ikke drift mellom schema.ts, db_setup.py, ingest.py**. Problemet er bare at pipeline ikke har kjørt. | 🛈 Operasjonelt |
